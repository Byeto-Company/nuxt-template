...
provide("ignoreUpdates", ignoreUpdates);
provide("shouldTrackContentChanges", shouldTrackContentChanges);
</script>
...
<template>
    ...
    >
        ...
        <Reorder.Group
            ...
            class="flex flex-col gap-9 !px-5 !py-9 container overflow-y-auto"
            layoutScroll
        >
            <Reorder.Item
