...
<template>
    ...
    >
        ...
        <div class="aspect-square shrink-0 w-14 rounded-md bg-neutral-900 text-white flex-center">
            <UIcon
        ...
        <div class="w-full pe-3 flex flex-col items-start justify-between">
            <NuxtLink
                ...
                target="_blank"
                download
                class="overflow-hidden text-ellipsis max-w-8/12 hover:underline underline-offset-2"
            >
                {{ data.name }}
            </NuxtLink>
